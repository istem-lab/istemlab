...
const projects = [
  {
    ...
    description: "Our latest AI-powered geospatial tool to revolutionize mapping and analysis.",
    status: "Completed",
  ...
  },
  {
    ...
    description: "An ongoing project to create detailed maps for the Melamchi region.",
    status: "InProgress",
  ...
  },
  {
    ...
    description: "Using geospatial data to improve disaster preparedness and response.",
    status: "InProgress",
  ...
  return (
    <div className="w-full px-2 py-10">
      <Alert className="mb-6" variant="info">
        ...
        <AlertDescription>
          Here is an overview of our recent and ongoing projects. Click "Read More" for detailed information.
        </AlertDescription>
      </Alert>
            ...
            <TableRow key={project.id}>
              <TableCell>
                ...
                <Link href={project.link}>
                  <p className="text-primary-600 hover:text-primary-800 font-semibold">Read More &rarr;</p>
                </Link>
              </TableCell>
              <TableCell>
